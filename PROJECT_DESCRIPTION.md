...
* **MSE Optimization Focus**: The project prioritizes minimizing Mean Squared Error (MSE). By squaring prediction errors, the models heavily penalize large forecasting misses. This guarantees that utility peak-loads are never under-forecasted, preventing utility overage penalties.
